...
const getMaravilhosaById = (request, response) => {
    ...
    const encontrarId = models.selectDataByKey('id', id)
    if(encontrarId) {
...
const deleteMaravilhosa = (request, response) => {
    ...
    if(parseInt(valor) == NaN) {
        console.log('a');
        encontrar = models.selectDataByKey('name', valor)
        
    } else {
        console.log('b');
        encontrar = models.selectDataByKey('id', valor)
    }
    
    if(encontrar) {
        const dataComExluido = models.deleteData(encontrar)
